...
// tests for CoinHistoryItemInput
void main() {
  // final instance = CoinHistoryItemInput();

  group('test CoinHistoryItemInput', () {
    ...
    // String otherName
    test('to test the property `otherName`', () async {
      // TODO
    });

    // int otherAvatarId
    test('to test the property `otherAvatarId`', () async {
      // TODO
    });
