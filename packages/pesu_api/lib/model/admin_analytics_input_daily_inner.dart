...
class AdminAnalyticsInputDailyInner {
  ...
  @override
  String toString() => 'AdminAnalyticsInputDailyInner[date=$date, calls=$calls, minutes=$minutes, coinsSpent=$coinsSpent, salesPaise=$salesPaise, earningsPaise=$earningsPaise, newCallers=$newCallers, newCompanions=$newCompanions, activeCallers=$activeCallers, missedCalls=$missedCalls, avgRating=$avgRating]';
  ...
  static AdminAnalyticsInputDailyInner? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        ...
        assert(json.containsKey(r'missedCalls'), 'Required key "AdminAnalyticsInputDailyInner[missedCalls]" is missing from JSON.');
        assert(json[r'missedCalls'] != null, 'Required key "AdminAnalyticsInputDailyInner[missedCalls]" has a null value in JSON.');
        assert(json.containsKey(r'avgRating'), 'Required key "AdminAnalyticsInputDailyInner[avgRating]" is missing from JSON.');
        return true;
      }());
