...
class UpdateMeRequest {
  ...
  @override
  String toString() => 'UpdateMeRequest[displayName=$displayName, avatarId=$avatarId, primaryLanguage=$primaryLanguage, languages=$languages]';
